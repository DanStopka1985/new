...
/*
Здесь мы видим полный обход страницы и только потом сортировку top-N heapsort
...
/*
в плане берутся первые (в алфавитном порядке СНИЛС) 50 узлов индекса, затем из этих узлов берутся indiv_id
...
После этого отсортировать Sort Method: top-N heapsort - сортировка кучей или пирамидальная сортировка
*/
